package io.github.kimovoid.reframed.lwjgl3compat.implementation.glfw;
...
import io.github.kimovoid.reframed.lwjgl3compat.util.GlStateManager;
import io.github.kimovoid.reframed.lwjgl3compat.util.XDGPathResolver;
import lombok.Data;
...
public class VirtualGLFWMouseImplementation implements MouseImplementation {
	...
	private boolean isValidScreen() {
		Screen s = Minecraft.INSTANCE.screen;
